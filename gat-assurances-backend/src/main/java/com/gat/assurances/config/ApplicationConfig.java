...
/**
 * Déclare les beans Spring Security requis :
 *  - UserDetailsService  → charge l'utilisateur depuis la DB
 *  - AuthenticationProvider → vérifie les credentials (DaoAuthenticationProvider)
